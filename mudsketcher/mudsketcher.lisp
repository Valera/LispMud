...
#+nil (make-instance 'drawing-area))
	...
	(connect-signal mob-list-view "cursor-changed" #+nil"row-activated" (lambda (&rest data) (debug-out (format nil "~a ~a~%" data (tree-model-item (tree-view-model (first data)) (tree-view-get-cursor (first data))) #+nil(tree-model-value (first data) (tree-model-iter-by-path (first data) (second data)) 0))) (setf *a* (second data))))
